...
const PopularJobCard: React.FC<IPopularJobCard> = ({
	...
	return (
		<div
			...
			className="flex md:flex-row flex-col md:p-4 pb-2 px border border-gray-300 bg-white rounded-xl md:space-x-4 space-x-0 md:space-y-0 space-y-2 w-full hover:cursor-pointer"
		>
			<div
				className={`${
