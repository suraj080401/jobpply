...
import { topTenJobs } from "@/utils/schema";
import { CiLocationOn } from "react-icons/ci";
import { MdAccessTime } from "react-icons/md";
import { HiOutlineCurrencyRupee } from "react-icons/hi";
import { MdOutlineWorkOutline } from "react-icons/md";

const TopJobCard: React.FC<topTenJobs> = ({
	role,
	location,
	salary,
	company,
	...
	return (
		<div className="p-4 border border-2 rounded-lg bg-white flex lg:flex-row flex-col lg:space-x-4 lg:space-y-0 space-y-2">
			...
			<div className="flex flex-col space-y-1 lg:items-start items-center ">
				<div>
					<p className="lg:text-lg text-md font-bold">{role}</p>
				</div>
				<div className="flex flex-col items-center space-y-2 lg:items-start text-gray-500">
					...
					<div className="flex flex-row space-x-4">
						...
						<div className="flex flex-row items-center space-x-1">
							...
							<div>
								<p className="text-sm">{salary} lpa</p>
							</div>
						</div>
					</div>
